...
public class RegularizationApprovalTest2 extends BaseTest {
...
//       List<WebElement> table = driverR.findElements(By.xpath("//table[@class=\"text-uppercase mx-2 px-2 btn btn-primary btn-sm\"]//tbody//tr"));
       ...
       for(int i=1 ;i<=tablesize ;i++)
       {
           ...
           RegularizeDate = driverR.findElement(By.xpath("//*[@class=\"shadow table table-sm table-striped table-bordered\"]//tbody//td[2]//span['+i+']")).getText();
...
//    	   sf.assertAll();
	...
	public void ValidateApproveRegularizationFunctionality() throws InterruptedException, IOException
	{
       ...
       driverR.findElement(By.xpath("(//td[contains(text(),'"+RegularizeDate+"')])//following::td[1]//button")).click();
