...
public class Enterprise_StructuredTimesheetSubmissionApproval_MissingClockOut extends BaseTest {
...
//        Utility.waitForSeconds(1);
	...
	@Test(priority=1)
	public void shouldNotSubmitTimesheet_WhenTaskMissing() throws InterruptedException, IOException
	{
     LoginAsUser();
	...
	@Test(priority=2)
	public void creatingWeeklyTimesheetEntry() throws InterruptedException, IOException
	{
...
//	    sendAttendanceData2(token, "CLOCK_OUT", dateStr, addHours(baseTime, 9));
    	...
    	@Test(priority=3)
    	public void addingTaskToavailableEntry() throws InterruptedException, IOException
    	{
...
//						Utility.waitForSeconds(2);
		    	...
		    	@Test(priority=4)
		    	public void validatingErrorMsgOnTimesheetSubmission() throws InterruptedException, IOException
		    	{
...
//               	Utility.highlightElement(submitBtn);
		            ...
		            WebElement ConfirmAlert = driverR.findElement(By.xpath("//*[contains(text(),'All timesheets for this week must be clocked out before submission.')]"));
