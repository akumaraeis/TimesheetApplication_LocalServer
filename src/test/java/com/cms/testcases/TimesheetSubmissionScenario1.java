...
//		Thread.sleep(1000);
		...
		for (int index = 2; index <= totalWeeks; index++) {
		    ...
		    WebElement statusElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(@class,'px-3 py-2 mx-auto w-100 text-sm badge text-dark bg-warning')]")));
